...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .antMatchers("/user/**", "/auth/reset-password", "/auth/forgot-password", "/productCategory/**","/user/emailTokenSend","/user/verifyEmailToken").permitAll()  // Allow access without JWT
