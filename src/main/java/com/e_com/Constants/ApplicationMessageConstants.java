...
public interface ApplicationMessageConstants {
	public interface ServiceErrorMessages {
		...
		String ERR_SAVE_PRODUCTCATEGORYLEVEL2_DETAILS = "err.save.product.category.level2.details";
		String EX_SAVE_PRODUCTCATEGORYLEVEL2_DETAILS = "ex.save.product.category.level2.details";
		String ERR_RETRIEVE_ALL_PRODUCTCATEGORYLEVEL2_DETAILS = "err.get.all.product.category.level2.details";
		String EX_RETRIEVE_ALL_PRODUCTCATEGORYLEVEL2_DETAILS = "ex.get.all.product.category.level2.details";
		String ERR_RETRIEVE_PAGINATED_PRODUCTCATEGORYLEVEL2_DETAILS = "err.get.paginated.product.category.level2.details";
		String EX_RETRIEVE_PAGINATED_PRODUCTCATEGORYLEVEL2_DETAILS = "ex.get.paginated.product.category.level2.details";
		String ERR_UPDATE_PRODUCTCATEGORYLEVEL2_DETAILS = "err.update.product.category.level2.details";
		String EX_UPDATE_PRODUCTCATEGORYLEVEL2_DETAILS = "ex.update.product.category.level2.details";
		String ERR_RETRIEVE_PRODUCTCATEGORYLEVEL2_BY_NAME = "err.get.by.product.category.level2.name";
		String EX_RETRIEVE_PRODUCTCATEGORYLEVEL2_BY_NAME = "ex.get.by.product.category.level2.name";
		String ERR_UPDATE_PRODUCTCATEGORYLEVEL2_STATUS = "err.update.product.category.level2.status";
		String EX_UPDATE_PRODUCTCATEGORYLEVEL2_STATUS = "ex.update.product.category.level2.status";
		String ERR_RETRIEVE_PRODUCTCATEGORYLEVEL2_BY_ID ="err.get.by.product.category.level2.id";
		String EX_RETRIEVE_PRODUCTCATEGORYLEVEL2_BY_ID="ex.get.by.product.category.level2.id";
		...
		String ERR_SAVE_PRODUCT_CATEGORY_LEVEL1_DETAILS = "err.save.product.category.level1.details";
        String EX_SAVE_PRODUCT_CATEGORY_LEVEL1_DETAILS = "ex.save.product.category.level1.details";
        String ERR_UPDATE_PRODUCT_CATEGORY_LEVEL1_DETAILS = "err.update.product.category.level1.details";
        String EX_UPDATE_PRODUCT_CATEGORY_LEVEL1_DETAILS = "ex.update.product.category.level1.details";
        String ERR_UPDATE_PRODUCT_CATEGORY_LEVEL1_STATUS = "err.update.product.category.level1.status";
        String EX_UPDATE_PRODUCT_CATEGORY_LEVEL1_STATUS = "ex.update.product.category.level1.status";
        String ERR_RETRIEVE_ALL_PRODUCT_CATEGORY_LEVEL1_DETAILS = "err.retrieve.all.product.category.level1.details";
        String EX_RETRIEVE_ALL_PRODUCT_CATEGORY_LEVEL1_DETAILS = "ex.retrieve.all.product.category.level1.details";
		...
		String ERR_RETRIEVE_PAGINATED_PRODUCTCATEGORY_LEVEL3_DETAILS = "err.get.paginated.product.category.level3.details";
		String EX_RETRIEVE_PAGINATED_PRODUCTCATEGORY_LEVEL3_DETAILS = "ex.get.paginated.product.category.level3.details";
		String ERR_SAVE_PRODUCTCATEGORY_LEVEL3_DETAILS = "err.save.product.category.level3.details";
		String EX_SAVE_PRODUCTCATEGORY_LEVEL3_DETAILS = "ex.save.product.category.level3.details";
		String ERR_UPDATE_PRODUCTCATEGORY_LEVEL3_DETAILS = "err.update.product.category.level3.details";
		String EX_UPDATE_PRODUCTCATEGORY_LEVEL3_DETAILS = "ex.update.product.category.level3.details";
		String ERR_RETRIEVE_PRODUCTCATEGORY_LEVEL3_BY_NAME = "err.get.by.product.category.level3.name";
		String EX_RETRIEVE_PRODUCTCATEGORY_LEVEL3_BY_NAME = "ex.get.by.product.category.level3.name";
		String ERR_UPDATE_PRODUCTCATEGORY_LEVEL3_STATUS = "err.update.product.category.level3.status";
		String EX_UPDATE_PRODUCTCATEGORY_LEVEL3_STATUS = "ex.update.product.category.level3.status";
		String ERR_RETRIEVE_PRODUCTCATEGORY_LEVEL3_BY_ID ="err.get.by.product.category.level3.id";
