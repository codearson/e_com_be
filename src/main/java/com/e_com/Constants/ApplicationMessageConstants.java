...
public interface ApplicationMessageConstants {
	public interface ServiceErrorMessages {
        ...
        String ERR_SAVE_PRODUCT_CATEGORY_DETAILS = "ERR_SAVE_PRODUCT_CATEGORY_DETAILS";
        String EX_SAVE_PRODUCT_CATEGORY_DETAILS = "EX_SAVE_PRODUCT_CATEGORY_DETAILS";
        String ERR_UPDATE_PRODUCT_CATEGORY_DETAILS = "ERR_UPDATE_PRODUCT_CATEGORY_DETAILS";
        String EX_UPDATE_PRODUCT_CATEGORY_DETAILS = "EX_UPDATE_PRODUCT_CATEGORY_DETAILS";
        String ERR_UPDATE_PRODUCT_CATEGORY_STATUS = "ERR_UPDATE_PRODUCT_CATEGORY_STATUS";
        String EX_UPDATE_PRODUCT_CATEGORY_STATUS = "EX_UPDATE_PRODUCT_CATEGORY_STATUS";
        String ERR_RETRIEVE_ALL_PRODUCT_CATEGORY_DETAILS = "ERR_RETRIEVE_ALL_PRODUCT_CATEGORY_DETAILS";
        String EX_RETRIEVE_ALL_PRODUCT_CATEGORY_DETAILS = "EX_RETRIEVE_ALL_PRODUCT_CATEGORY_DETAILS";
