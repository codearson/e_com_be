...
import com.e_com.Dto.ResponseDto; // Using the provided ResponseDto structure
...
/**
 * Title: TwoStepVerifyServiceBL.java. Company: www.codearson.com Copyright: Copyright (c) 2025.
 *
...
public class TwoStepVerifyServiceBL {
    ...
    public String twoFaRequest(TwoStepOtpVerificationRequestDto request) {
	    ...
	    String emailBody = "Hi " + user.getFirstName() + ",\n\n" + 
	                       "Your 2-Step Verification code is: " + token.getToken() + "\n\n" + 
